...
if( !regExp_flag_u_support || !regExp_flag_y_support ) {
	...
	if ( !regExp_flag_u_support ) {
		unescapeUnicode = _785200061404369367715_1_require___lib_unescapeUnicode_js();
...
//					throw new Error('Invalid unicode range');
			...
			var es6unicodeRangeConverter = _785200061404369367715_2_require___lib_rangeRegenerate_js();
			...
			_785200061404369367715_3_require___String_fromCodePoint_js();
...
//					'|((?:[\\0-\\u005A\\u005C\\u005F-\\uD7FF\\uDC00-\\uFFFF][\\uDC00-\\uDFFF]|[\\uD800-\\uDBFF]|[\\uD800-\\uDBFF])+?)' +
	...
	if( !regExp_flag_y_support ) {
		...
		_785200061404369367715_4_require___String__RE_methods_js()(global, $RegExp, updateGlobalRegExpProperties);
	}
}

//})();

;function _785200061404369367715_1_require___lib_unescapeUnicode_js(){var module = {exports: {}};/*global module:False*/
/*es6-transpiler symbols:false, has-iterators:false, has-generators: false,*/
...
;function _785200061404369367715_2_require___lib_rangeRegenerate_js(){var module = {exports: {}};/*global module:false*/
/*es6-transpiler symbols:false, has-iterators:false, has-generators: false,*/
// call require: from RegExp polyfill
...
;return module.exports};
;function _785200061404369367715_3_require___String_fromCodePoint_js(){var module = {exports: {}};/*global module:false*/
/*es6-transpiler symbols:false, has-iterators:false, has-generators: false*/
// call require: from RegExp polyfill
...
;return module.exports};
;function _785200061404369367715_4_require___String__RE_methods_js(){var module = {exports: {}};/*global module*/
/*es6-transpiler symbols:false, has-iterators:false, has-generators: false*/
// call require: from RegExp polyfill
